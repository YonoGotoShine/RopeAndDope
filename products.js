...
{  
    for(let i=0; i<Product_table.length; i++)
    {
        ...
        {
            document.write('<div><img src=' + Product_table[i].img + '></div><div id="obok"> '+'<p>Nazwa: ' + Product_table[i].name +' Opis: ' + Product_table[i].description + ' Cena: ' + Product_table[i].price +  '</div><br><br><br>')
        }
